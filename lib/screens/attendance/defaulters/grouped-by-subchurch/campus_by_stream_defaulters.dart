...
class CampusByStreamAttendanceDefaultersScreen extends StatelessWidget {
  const CampusByStreamAttendanceDefaultersScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GQLQueryContainer(
      query: getCampusAttendanceDefaultersByStream,
      ...
      bodyFunction: (data, [fetchMore]) {
        ...
        final campus = ChurchBySubChurchForAttendanceDefaulters.fromJson(data?['campuses'][0]);

        body = ChurchBySubChurchAttendanceDefaulters(church: campus);
