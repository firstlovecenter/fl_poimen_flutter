...
class ConstituencyServiceAttendanceDefaultersScreen extends StatelessWidget {
  const ConstituencyServiceAttendanceDefaultersScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GQLQueryContainer(
      query: getConstituencyFellowshipServiceAttendanceDefaultersList,
      ...
      bodyFunction: (data, [fetchMore]) {
        ...
        final constituency =
            ChurchForServiceAttendanceDefaultersList.fromJson(data?['constituencies'][0]);
