...
class CouncilServiceAttendanceDefaultersScreen extends StatelessWidget {
  const CouncilServiceAttendanceDefaultersScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GQLQueryContainer(
      ...
      bodyFunction: (data, [fetchMore]) {
        ...
        final council = ChurchForServiceAttendanceDefaultersList.fromJson(data?['councils'][0]);
