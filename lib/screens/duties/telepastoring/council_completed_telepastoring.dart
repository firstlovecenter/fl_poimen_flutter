...
class CouncilCompletedTelepastoringScreen extends StatelessWidget {
  const CouncilCompletedTelepastoringScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GQLQueryContainer(
      ...
      defaultPageTitle: 'Council Completed Telepastorings',
